package com.twiliovideocalldemo.activity;
...
import com.twiliovideocalldemo.BuildConfig;
import com.twiliovideocalldemo.R;
import com.twiliovideocalldemo.dialog.DialogUtils;
import com.twiliovideocalldemo.util.CameraCapturerCompat;
...
public class VideoCallActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_settings:
                startActivity(new Intent(this, VideoSettingsActivity.class));
                return true;
    ...
    private void showConnectDialog() {
        ...
        connectDialog = DialogUtils.createConnectDialog(roomEditText,
